...
Args:
    ...
    - ``guardrails (bool)``: Enables guardrails that provide additional checks and balances.
    - ``guardrails_kwargs (dict)``: Additional keyword arguments for configuring guardrails.
